...
class PaymentCareerService
{
    ...
    function sfSendPaygentAuthCareer($arrData, $arrInput, $order_id, $transactionid, $pc_mobile_type) {
    	...
    	// 認証OKURL
    	$arrSend['redirect_url'] = $this->app->url('homepage') . "shopping/mdl_paygent?mode=career_authentication&order_id=" . $order_id . "&" . $transactionIdName . "=" . $transactionid;
    	// 認証NGURL
    	$arrSend['cancel_url'] = $this->app->url('homepage') . "shopping/mdl_paygent?mode=career_authentication_cancel&order_id=" . $order_id . "&" . $transactionIdName . "=" . $transactionid;
    	// PC/Mobile区分
