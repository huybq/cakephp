...
class ConfigType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if (isset($this->connectType) && $this->connectType == "1") {
        	$builder = $this->getFormLinkType($builder, $arrPayments, $arrPaymentDivisions, $arrCareerDivisions);
        } else if (isset($this->connectType) && $this->connectType == "3") {
			$builder = $this->getFormMixedType($builder, $arrPayments, $arrPaymentDivisions, $arrCareerDivisions);
        } else {
    ...
    public function getFormLinkType(FormBuilderInterface $builder, $arrPayments,
    		$arrPaymentDivisions, $arrCareerDivisions)
    {
    	$builder
